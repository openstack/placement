...
class TestAllocationListCreateDelete(tb.PlacementDbBaseTestCase):
    ...
    def test_allocation_checking(self):
        ...
        allocation_2 = alloc_obj.Allocation(
            ...
            used=rp2_used)
        allocation_list = alloc_obj.AllocationList(
    ...
    def test_allocation_list_create(self):
        ...
        consumer_allocations = alloc_obj.AllocationList.get_all_by_consumer_id(
    ...
    def test_set_allocations_retry(self, mock_log):
        ...
        with mock.patch.object(alloc_obj.AllocationList,
        ...
        with mock.patch.object(alloc_obj.AllocationList,
            ...
            unmocked_set = functools.partial(
                alloc_obj.AllocationList._set_allocations, alloc_list)
